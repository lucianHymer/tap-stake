...
export type IconName =
  | 'pixel/heart' | 'pixel/leaf' | 'pixel/plant' | 'pixel/plus' | 'pixel/read' | 'pixel/search' | 'pixel/skull' | 'pixel/sword' | 'pixel/wand' | 'pixel/web' | 'pixel/x' | 'glyph/burst' | 'glyph/flame' | 'glyph/icon-stylized-solid' | 'glyph/key' | 'glyph/star' | 'glyph/sword';
