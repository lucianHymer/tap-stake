...
export const Interactive = () => {
  const [activeChoice, setActiveChoice] = useState<"giveth" | "taketh" | null>(
    null,
  );
...
export const MultipleOptions = () => {
  ...
  const choices: Array<{
    id: string;
    name: string;
    stats: { major: StatName; minor: StatName };
  }> = [
    {
      id: "warrior",
      name: "Warrior",
...
MultipleOptions.parameters = {
  docs: {
    description: {
      story:
        "Example with multiple choice options. Only one can be active at a time.",
    },
  },
};
